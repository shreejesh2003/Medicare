          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              <figure className="max-w-[200px] max-h-[200px]">
                <img src={photo} alt="" calssName="w-full"></img>
              </figure>
              <div>
            ...
            <div className="mt-[50px] border-b border-solid border-[#0066f34]">
              <button
                ...
                className={
                  "${tab==='about'&&'border-b border-solid border-primaryColor'} py-2 px-5 mr-5 text-[16px] leading-7 text-headingColor font-semibold"
                }
              >
                About
              </button>
              <button
                ...
                className={
                  "${tab==='feedback'&&'border-b border-solid border-primaryColor'} py-2 px-5 mr-5 text-[16px] leading-7 text-headingColor font-semibold"
                }
              >
                Feedback
              </button>
