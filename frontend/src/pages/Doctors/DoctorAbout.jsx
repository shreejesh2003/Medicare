...
const DoctorAbout = ({name,about,qualifications,experiences}) => {
  return (
    ...
    <div><h3 className='text-[20px] leading-[30px] text-headingColor font-semibold flex items-center gap-2'>About of
    <span className='text-irisBlueColor font-bold text-[24px] leading-9'>{name}</span></h3>
    <p className="text__para">{about}.</p>
    </div>
    
    <div className="mt-12"><h3 className='text-[20px] leading-[30px] text-headingColor font-semibold '>Educations </h3>
    ...
    <ul className='grid sm:grid-cols-2 gap-[30px] pt-4 md:p-5'>
        {
            ...
            <p className='text-[16px] leading-5 font-medium text-textColor'>{item.position}</p>
