    ...
    <div className="mt-2 lg:mt-4 flex items-center justify-between">
       ...
       {specialization}
        ...
        <div className="flex items-center gap-[6px]">
            ...
            <span className='text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-semibold text-textColor' >({totalRating})</span>
        </div>
        </div>
        <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
            ...
            <Link
                  ...
                  className="w-[44px] h-[44px] rounded-full border-solid border-[#181A1E] flex items-center justify-center hover:bg-primaryColor hover:border-none"
                >
