...
<Link to='/doctors' className="w-[44px] h-[44px] rounded-full border-solid border-[#181A1E] mt-[30px]  flex items-center justify-center hover:bg-primaryColor hover:border-none">
              <BsArrowRight className="group-hover:text-white w-6 h-5"/>
            </Link>
            {/***********************not background color comming========================= */}
